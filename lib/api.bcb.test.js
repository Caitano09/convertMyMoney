...
const { getCotacaoAPI, extractCotacao } = require('./api.bcb')
...
test('getUrl', () => {
    ...
    expect(url).toBe(`https://olinda.bcb.gov.br/olinda/servico/PTAX/versao/v1/odata/CotacaoDolarDia(dataCotacao=@dataCotacao)?@dataCotacao='MINHA-DATA'&$format=json&$select=cotacaoCompra,cotacaoVenda,dataHoraCotacao`)
})
...
test('getCotacao', () => {
    ...
    getToday.mockReturnValue('06-16-2020')
